...
const projects = [
  ...
  {
    title: "AI Powered Content Concierge",
    tags: ["Python", "PostgreSQL", "Grok API", "Gemini API", "SQLAlchemy", "SMTP", "Automation"],
    desc: "An AI content automation system where Grok API transcribes source audio and Gemini API uses those transcripts to produce higher-quality, more effective summaries for digest delivery.",
    github: "https://github.com/Fuad-Rafi/AI-Powered-Content-Concierge",
    readmeLink: "https://github.com/Fuad-Rafi/AI-Powered-Content-Concierge/blob/main/README.md",
    images: [
      "/AI%20Concierge/c1.PNG",
      "/AI%20Concierge/c2.PNG",
      "/AI%20Concierge/c3.PNG",
      "/AI%20Concierge/c4.PNG",
    ],
    details: [
      "Built with two APIs for different purposes: Grok API for transcription and Gemini API for summary generation",
      "Grok API converts incoming audio into reliable transcripts used as the core input for analysis",
      "Gemini API processes the transcript text to generate clearer, more effective summaries with better overall quality",
      "Pipeline structure: collect source content, transcribe with Grok, summarize with Gemini, then deliver digest output",
      "Designed for automation with traceable outputs and cleaner end-user digest readability",
    ],
  },
];
